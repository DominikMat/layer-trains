...
public:
    ...
    void recalculate_path (Line* line, vec3 start, vec3 end, float max_slope) override{        
        ...
        std::vector<vec3> path_left = terrain->elevation_line_drawer.generate_auto_slope_path(start,end,max_slope,step);
